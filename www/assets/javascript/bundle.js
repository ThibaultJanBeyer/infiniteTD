...
setSizes();b.onresize=function(){setSizes();};w.addEventListener('orientationchange',function(){setSizes();});}(function(){setTimeout(function(){init();},500);})();/****************//* Setup Fields *//****************//* Field */var Field=function(){function Field(pos){var _this=this;_classCallCheck(this,Field);this.e=createElement('button','board__field');this.locked=false;this.start=false;this.end=false;this.pos=pos;// field click
