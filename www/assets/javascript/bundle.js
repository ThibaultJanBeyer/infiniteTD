...
scoreboard.elements.forEach(function(e){addClass(e,'scoreboard__el--alt');});addClass(scoreboard.e,'scoreboard--alt');addClass(board.e,'board--alt');var _i5=fields.length;while(_i5--){fields[_i5].e.style.width=board.clientWidth/10+'px';fields[_i5].e.style.height=board.clientHeight/10+'px';}}// we will have to recalculate the exact
