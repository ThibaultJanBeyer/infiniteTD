...
setSizes();b.onresize=function(){setSizes();};w.addEventListener('orientationchange',function(){setSizes();});}document.addEventListener('deviceready',function(){AndroidFullScreen.immersiveMode();isDevice=true;init();},false);(function(){setTimeout(function(){if(!isDevice){init();}},2000);})();/* Main Loop */// window.requestAnimationFrame = (function(){
...
//   console.log('frame');
// })();
/****************//* Setup Fields *//****************//* Field */var Field=function(){function Field(pos){var _this=this;_classCallCheck(this,Field);this.e=createElement('button','board__field');this.locked=false;this.start=false;this.end=false;this.pos=pos;// field click
...
var _i2=allCreeps.length;while(_i2--){// check if the creeps distance is within tower range with
